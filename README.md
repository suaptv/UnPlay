...
- **[Top Shelf小组件](https://github.com/suaptv/UnPlay/blob/main/TopShelfList.md)**
...
此外，在繁忙的生活中，UnPlay也能给您带来宁静，让您享受安静聆听的时刻。 https://apps.apple.com/app/unplay/id6450034641

### 支持tvOS、iOS、macOS
苹果平台畅玩dlna投屏接收器

### 稳定强大的 DLNA 投屏引擎
基于 MPV 播放核心打造，适配多种复杂格式，兼容性远超普通播放器。
支持与 HomePod 协同播放，为你的家庭影院带来更自然的声画体验。
网页端也能推送视频到 Apple TV，并可组合成播放列表。
...
### 天气场景 (Apple TV)
- 接入 Apple Weather，展示准确高质量的天气信息
- 适用于客厅、小店、前台、大堂等作为“氛围屏”

### Top Shelf 小组件 (Apple TV)
- 幻灯片式顺序播放
- 静态图片长期显示 (保持 Apple TV 不进入睡眠)
- 循环播放 (保持 Apple TV 不进入睡眠)
- 视频列表循环播放 (保持 Apple TV 不进入睡眠)

使用场景: 火炉视频、海边视频、游戏短视频、家庭照片、节日照片 
...
### DLNA接收器
- 支持APP启动之后,保持后台运行进行DLNA投屏接收 (AppleTV)
- HTTP推送：网页端推送视频, 组合成列表播放(👉设置--HTTP投屏--查看IP--Safari浏览器打开)
...
![Screen Shot](https://raw.githubusercontent.com/suaptv/UnPlay/master/images/107.jpg)
