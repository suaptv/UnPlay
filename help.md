...
## 目录
- [1. 路由器 & 网络环境](#1-路由器--网络环境最容易被忽略)
- [2. 手机端设置](#2-手机端设置90-的人卡在这)
- [3. UnPlay TV端问题](#3-unplaytv端问题)
- [4. VPN / 网络工具 特殊配置](#4-vpn--网络工具-特殊配置)
- [5. 终极重启大法](#5-终极重启大法别笑真的有用)
- [6. 最后的话](#6-最后的话)
...
| App | 现象 | 解决方法 |
|-----|------|----------|
| 咪咕视频 | 第一次投屏搜不到 | 杀掉后台重开 |
| 任意 App | 列表里好像有设备 | **上下滑动一下列表**（UI 渲染问题） |
| 部分国产 App | 点两次才出设备 | App 本身做得烂，多点一次 |

---
## 3️⃣ UnPlay（TV端）问题

### ❌ 异常情况
- 🚫 **不要升级测试版系统**（API 不稳定，导致投屏失败）
